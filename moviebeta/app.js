...
// Search function
function UpdateFilmlist(app, source) {
    //TODO: Returns bio films right now
    var search = 'bio';
    console.log("searching for '" + search + "'");
    source.get("list", null, { 'id': search }, function (request) {
...
var app = new Ractive({
    ...
    data: {
        ...
        movies: function () {
            ...
            return _.filter(all_films, function (movie) {
...
app.on('view-movie', function (event, movie) {
    this.set({
        currentMovie: movie
    });
});
